...
export default function Register()
{
    ...
    const { doRequest, requestErrors } = useRequest( {
        url: '/api/users/singup', method: 'post', body: { data }, onSuccess: ( response ) => console.log( response )
    } );
                ...
                <form onSubmit={handleSubmit( onSubmit )} className={classes.form} noValidate>
                    <Grid container spacing={2}>
                        ...
                        <Grid item xs={12}>
                            ...
                            <input name="imgUrl" ref={register( {} )} style={{ display: 'none' }} type='text' value={imgUrl} onChange={() => { }} />
                        </Grid>
                        <Grid item xs={12}>
                            <FormControlLabel
                                name="imgUrl"
